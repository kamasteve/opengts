...
<!-- jsp/loginSession_banner.jsp: <gts:var>${version} [${privateLabelName}]</gts:var>
  =======================================================================================
  Copyright(C) 2007-2016 GeoTelematic Solutions, Inc., All rights reserved
...
<gts:var if="isLocaleRTL" value="true">
    ...
    TD.titleText {
        /* background: #663399 url('./images/Banner_White90.png') center no-repeat; */
        /* background: #663399 url('./images/Banner_WhiteShadow.png') center no-repeat; */
...
<span class="icon-bar"></span>
   ...
   <a class="navbar-brand" > <img alt="Techisoft Logo" src="images/techisoft.png" class="hidden-xs"/>
                <span></span></a>
...
<tbody>
  ...
  <td width="100%">
    ...
    <tr> 
      ...
      <td width="860" height="120" class="titleText" halign="center">
        ${pageTitle}<br>
        <font style="font-size: 9pt;"><i>(Powered by <a href="http://www.opengts.org" target="_blank" style="color:#444444;">Techisoft Solutions</a>)</i></font>
      </td>
      </gts:var> 
  ...
  -->
     ...
     <div>
     <div>
       <div class="navBarClear" nowrap align="left">&nbsp;<gts:var ifKey="isLoggedIn" value="true"><i>${i18n.Account}:</i> ${accountDesc} (${userDesc})</gts:var></div>
    <div class="navBarClear" nowrap align="right" width="100%"><gts:var>&nbsp;${navigation}&nbsp;&nbsp;</gts:var></div> 
     </div>
     </div>
